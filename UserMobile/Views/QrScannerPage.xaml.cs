...
public partial class QrScannerPage : ContentPage
{
    ...
    private async void OnPlaceScanned(object? sender, PlaceItem place)
    {
        ...
        await DisplayAlertAsync(
            "QR POI",
            "QR chỉ dùng để mở chi tiết POI. App đã tự đồng bộ ngôn ngữ theo QR hoặc theo điện thoại. Muốn nhận điểm, hãy bấm Check-in bằng GPS khi bạn đang ở gần địa điểm.",
            "Đã hiểu");
    }
}
