...
public class UserController : Controller
{
    ...
    public async Task<IActionResult> DeleteTourist(int id)
    {
        ...
        try
        {
            ...
            TempData["SuccessMessage"] = "Đã xóa tài khoản du khách và tất cả dữ liệu liên quan.";
        }
        catch (Exception)
        {
            await transaction.RollbackAsync();
            TempData["ErrorMessage"] = "Đã xảy ra lỗi trong quá trình xóa. Thao tác đã được hoàn tác.";
        }
