...
public sealed class ReviewerAuditHistoryViewModel
{
    ...
    public IReadOnlyList<ReviewerAuditHistoryItemViewModel> Items { get; set; } = [];
}

public sealed class ReviewerAuditHistoryItemViewModel
{
