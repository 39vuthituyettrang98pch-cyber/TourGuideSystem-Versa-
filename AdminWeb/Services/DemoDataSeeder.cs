...
""";
    ...
    private async Task SeedRealOwnerPoiMenuAsync(DateTime now, CancellationToken cancellationToken)
    {
        ...
        _logger.LogInformation("Ensuring real Ho Chi Minh City owner POI menu demo data...");
        ...
        _logger.LogInformation("Real Ho Chi Minh City owner POI menu demo data ensured successfully.");
    }
    ...
    [
        ...
        new RealOwnerPoiMenuSeed(
            6,
            "nguyen-trai-bun-thit-nuong",
            "owner_nguyentrai_bun",
            "nguyentrai.bun.owner@versa.local",
            "owner123",
            "Bún Thịt Nướng Nguyễn Trãi",
            "Quản lý Bún Thịt Nướng Nguyễn Trãi",
            "0906000006",
            "421 Nguyễn Trãi, Phường 7, Quận 5, TP.HCM",
            "Bún Thịt Nướng Nguyễn Trãi",
            "Nguyen Trai Grilled Pork Noodles",
            10.755100m,
            106.670100m,
            45,
            ["food", "market"],
            "Gian hàng bún thịt nướng trên trục Nguyễn Trãi, dùng để demo cụm gian hàng cùng một con đường.",
            "Đây là gian hàng demo thuộc cụm ẩm thực Nguyễn Trãi. POI có vị trí gần các gian hàng khác trên cùng một tuyến đường để kiểm tra bộ lọc Gian hàng, xem menu, đặt món và theo dõi lượng khách theo khung giờ.",
            "A grilled pork noodle stall on Nguyen Trai Street for same-street shop cluster demos.",
            "This demo shop belongs to the Nguyen Trai food-stall cluster. It helps test the Shop filter, menu browsing, ordering and visitor traffic analytics by time range.",
            [
                new RealMenuItemSeed("Bún thịt nướng đặc biệt", "Bún thịt nướng kèm nem, chả giò và rau sống.", 55000m),
                new RealMenuItemSeed("Bún thịt nướng thường", "Phần bún thịt nướng cơ bản.", 42000m),
                new RealMenuItemSeed("Bún nem nướng", "Bún nem nướng ăn kèm rau và nước mắm.", 45000m),
                new RealMenuItemSeed("Chả giò thêm", "Phần chả giò gọi thêm.", 12000m),
                new RealMenuItemSeed("Nem nướng thêm", "Phần nem nướng gọi thêm.", 18000m),
                new RealMenuItemSeed("Trà tắc", "Đồ uống trà tắc.", 15000m),
                new RealMenuItemSeed("Nước suối", "Nước suối đóng chai.", 10000m)
            ]),
        new RealOwnerPoiMenuSeed(
            7,
            "nguyen-trai-tra-sua",
            "owner_nguyentrai_trasua",
            "nguyentrai.trasua.owner@versa.local",
            "owner123",
            "Trà Sữa Nguyễn Trãi",
            "Quản lý Trà Sữa Nguyễn Trãi",
            "0907000007",
            "429 Nguyễn Trãi, Phường 7, Quận 5, TP.HCM",
            "Trà Sữa Nguyễn Trãi",
            "Nguyen Trai Milk Tea",
            10.755250m,
            106.671000m,
            45,
            ["food", "shopping"],
            "Gian hàng trà sữa trên cùng tuyến Nguyễn Trãi, có menu đồ uống để demo đặt món.",
            "Trà Sữa Nguyễn Trãi là dữ liệu demo cho nhóm gian hàng đồ uống nằm cùng một con đường. Du khách có thể lọc Gian hàng, xem menu, chọn món và tạo đơn trong khu vực bản đồ.",
            "A milk tea stall on the same Nguyen Trai Street cluster.",
            "Nguyen Trai Milk Tea is a demo drink shop in the same-street shop cluster, supporting shop filtering, menu viewing and order creation.",
            [
                new RealMenuItemSeed("Trà sữa trân châu đường đen", "Trà sữa kèm trân châu đường đen.", 39000m),
                new RealMenuItemSeed("Trà sữa truyền thống", "Trà sữa vị truyền thống.", 32000m),
                new RealMenuItemSeed("Trà đào cam sả", "Trà đào cam sả thanh mát.", 35000m),
                new RealMenuItemSeed("Sữa tươi trân châu", "Sữa tươi kèm trân châu.", 42000m),
                new RealMenuItemSeed("Matcha latte", "Matcha latte đá.", 45000m),
                new RealMenuItemSeed("Topping trân châu", "Phần topping trân châu thêm.", 7000m),
                new RealMenuItemSeed("Topping pudding", "Phần topping pudding thêm.", 9000m)
            ]),
        new RealOwnerPoiMenuSeed(
            8,
            "nguyen-trai-banh-trang-nuong",
            "owner_nguyentrai_banhtrang",
            "nguyentrai.banhtrang.owner@versa.local",
            "owner123",
            "Bánh Tráng Nướng Nguyễn Trãi",
            "Quản lý Bánh Tráng Nướng Nguyễn Trãi",
            "0908000008",
            "437 Nguyễn Trãi, Phường 7, Quận 5, TP.HCM",
            "Bánh Tráng Nướng Nguyễn Trãi",
            "Nguyen Trai Grilled Rice Paper",
            10.755400m,
            106.671900m,
            45,
            ["food", "market"],
            "Gian hàng ăn vặt trên cùng tuyến Nguyễn Trãi, phù hợp demo menu món ăn đường phố.",
            "Bánh Tráng Nướng Nguyễn Trãi là một POI gian hàng ăn vặt trong cụm dữ liệu cùng con đường. Menu có nhiều món nhỏ để kiểm tra thao tác thêm món, số lượng và đặt đơn.",
            "A street-snack stall in the Nguyen Trai same-street cluster.",
            "This grilled rice paper stall provides street-food menu data for the same-street shop cluster and ordering demo.",
            [
                new RealMenuItemSeed("Bánh tráng nướng thập cẩm", "Bánh tráng nướng trứng, xúc xích, bò khô và phô mai.", 30000m),
                new RealMenuItemSeed("Bánh tráng nướng phô mai", "Bánh tráng nướng kèm phô mai.", 28000m),
                new RealMenuItemSeed("Bánh tráng trộn", "Bánh tráng trộn ăn vặt.", 25000m),
                new RealMenuItemSeed("Bánh tráng cuốn bơ", "Bánh tráng cuốn bơ.", 27000m),
                new RealMenuItemSeed("Xúc xích nướng", "Xúc xích nướng gọi thêm.", 15000m),
                new RealMenuItemSeed("Trà chanh", "Đồ uống trà chanh.", 15000m),
                new RealMenuItemSeed("Nước sâm lạnh", "Nước sâm giải khát.", 18000m)
            ]),
        new RealOwnerPoiMenuSeed(
            9,
            "nguyen-trai-com-ga",
            "owner_nguyentrai_comga",
            "nguyentrai.comga.owner@versa.local",
            "owner123",
            "Cơm Gà Nguyễn Trãi",
            "Quản lý Cơm Gà Nguyễn Trãi",
            "0909000009",
            "445 Nguyễn Trãi, Phường 7, Quận 5, TP.HCM",
            "Cơm Gà Nguyễn Trãi",
            "Nguyen Trai Chicken Rice",
            10.755550m,
            106.672800m,
            45,
            ["food", "market"],
            "Gian hàng cơm gà trên cùng tuyến Nguyễn Trãi, có món chính, món thêm và đồ uống.",
            "Cơm Gà Nguyễn Trãi thuộc cụm gian hàng demo được đặt gần nhau trên bản đồ. Dữ liệu này giúp kiểm tra lọc gian hàng, menu đầy đủ, đặt món và báo cáo khách theo quán.",
            "A chicken rice shop in the Nguyen Trai same-street demo cluster.",
            "This chicken rice POI belongs to the same-street shop cluster for testing shop filters, menu ordering and visitor reports.",
            [
                new RealMenuItemSeed("Cơm gà xối mỡ", "Cơm gà xối mỡ da giòn.", 52000m),
                new RealMenuItemSeed("Cơm gà luộc", "Cơm gà luộc truyền thống.", 48000m),
                new RealMenuItemSeed("Cơm gà rô ti", "Cơm gà rô ti sốt đậm vị.", 55000m),
                new RealMenuItemSeed("Gà thêm", "Phần gà gọi thêm.", 35000m),
                new RealMenuItemSeed("Canh rong biển", "Canh rong biển ăn kèm.", 12000m),
                new RealMenuItemSeed("Dưa leo thêm", "Phần dưa leo thêm.", 5000m),
                new RealMenuItemSeed("Pepsi", "Nước ngọt Pepsi.", 15000m)
            ]),
        new RealOwnerPoiMenuSeed(
            10,
            "nguyen-trai-ca-phe-hem",
            "owner_nguyentrai_cafe",
            "nguyentrai.cafe.owner@versa.local",
            "owner123",
            "Cà Phê Hẻm Nguyễn Trãi",
            "Quản lý Cà Phê Hẻm Nguyễn Trãi",
            "0910000010",
            "453 Nguyễn Trãi, Phường 7, Quận 5, TP.HCM",
            "Cà Phê Hẻm Nguyễn Trãi",
            "Nguyen Trai Alley Coffee",
            10.755700m,
            106.673700m,
            45,
            ["food", "culture"],
            "Quán cà phê nhỏ trong cụm gian hàng Nguyễn Trãi, có menu nước uống đầy đủ.",
            "Cà Phê Hẻm Nguyễn Trãi là POI gian hàng đồ uống nằm cùng tuyến với các quầy ẩm thực demo. Người dùng có thể lọc Gian hàng để thấy toàn bộ cụm quán trên cùng một con đường.",
            "A small alley coffee shop in the Nguyen Trai same-street cluster.",
            "This coffee shop is part of the Nguyen Trai demo cluster, helping users filter shops and view a group of stalls on one street.",
            [
                new RealMenuItemSeed("Cà phê sữa đá", "Cà phê sữa đá kiểu Việt.", 28000m),
                new RealMenuItemSeed("Cà phê đen đá", "Cà phê đen đá.", 24000m),
                new RealMenuItemSeed("Bạc xỉu", "Bạc xỉu đá.", 30000m),
                new RealMenuItemSeed("Cacao đá", "Cacao sữa đá.", 32000m),
                new RealMenuItemSeed("Trà vải", "Trà vải đá.", 35000m),
                new RealMenuItemSeed("Bánh flan", "Bánh flan ăn kèm cà phê.", 18000m),
                new RealMenuItemSeed("Combo cà phê + bánh flan", "Combo đồ uống và bánh flan.", 42000m)
            ])
